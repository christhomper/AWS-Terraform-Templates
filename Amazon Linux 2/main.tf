...
resource "aws_launch_configuration" "CT_Alnx2" {
  name                 = "CT_Alnx2"
  image_id             = "ami-0fdf8021025d6d486"
...
resource "aws_autoscaling_group" "CT_Alnx2" {
  launch_configuration = aws_launch_configuration.CT_Alnx2.name
  min_size             = 1
  desired_capacity     = 1
  max_size             = 5
